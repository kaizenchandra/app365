...
public class SimpleOAuth2ExceptionJackson2Deserializer extends StdDeserializer<OAuth2Exception> {

    public SimpleOAuth2ExceptionJackson2Deserializer() {
    ...
    public OAuth2Exception deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        ...
        String errorMessage = errorParams.get("message") != null ? errorParams.get("message").toString() : null;
        ...
        SimpleOAuth2Exception simpleOAuth2Exception = new SimpleOAuth2Exception(ex.getMessage(), ex.getCause());
        simpleOAuth2Exception.setHttpErrorCode(ex.getHttpErrorCode());
        simpleOAuth2Exception.setOAuth2ErrorCode(ex.getOAuth2ErrorCode());
        simpleOAuth2Exception.setAdditionalInformation(ex.getAdditionalInformation());

        return simpleOAuth2Exception;
    }
}
