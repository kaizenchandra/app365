...
package com.synechisveltiosi.apis.app365.events.dto;
...
public class EventResponse {
    ...
    public EventResponse withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public EventResponse withContent(String content) {
        this.content = content;
        return this;
    }
    ...
    public EventResponse withStartDate(Date startDate) {
        this.startDate = startDate;
        return this;
    }
    ...
    public EventResponse withCreatedAt(Date createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public EventResponse withCoverPicture(String coverPicture) {
        this.coverPicture = coverPicture;
        return this;
    }
    ...
    public EventResponse withFlagged(Boolean flagged) {
        this.flagged = flagged;
        return this;
    }
    ...
    public EventResponse withLocation(LocationResponse location) {
        this.location = location;
        return this;
    }
    ...
    public EventResponse withSummary(UserActionSummaryResponse summary) {
        this.summary = summary;
        return this;
    }
    ...
    public EventResponse withMeta(DefaultMetaResponse meta) {
        this.meta = meta;
        return this;
    }
    ...
    public EventResponse withCursor(CursorResponse cursor) {
        this.cursor = cursor;
        return this;
    }
