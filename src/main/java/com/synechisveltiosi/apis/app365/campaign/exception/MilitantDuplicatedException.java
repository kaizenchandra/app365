...
public class MilitantDuplicatedException extends ConflictException {

    public MilitantDuplicatedException() {
        this("Militant duplicated.");
    }

    public MilitantDuplicatedException(String message) {
        super(message);
        this.setCode(ApiStatusCode.DUPLICATED_MILITANT);
    }
